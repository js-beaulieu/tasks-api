// Package testdb provisions isolated Postgres databases for integration tests
// using a shared Testcontainers container.
package testdb
...
// returns a DSN that callers can open with an app-local postgres.Open helper that
